...
url = f"https://www.google.it/search?q={encoded_query}&gbv=1"

# User agent obsoleto (IE 6.0) che non supporta JS
headers = {
...
print(f"Google IE6: status={r.status_code}, length={len(r.text)}")
