...
print(f"Total unique songs in RTL+RDS+Italia: {len(combined_songs)}")

need_scraping = []
pre_2010 = 0
for song in sorted(combined_songs):
    # check year
...
print(f"Pre-2010 songs (skipped): {pre_2010}")
print(f"Songs needing scraping: {len(need_scraping)}")
for s in need_scraping[:20]:
    print("  -", s)
