...
JSON_DB   = 'radio_nostalgia_history.json'
EXCEL_OUT = 'classifica_radio_nostalgia_STORICO.xlsx'
URL_BASE  = "https://onlineradiobox.com/it/nostalgiatoscana875/playlist/"
...
def main():
    ...
    print("Aggiornamento dati Radio Nostalgia Toscana...", flush=True)
    added_count = 0
    for i in range(7):
    ...
    ws = workbook.add_worksheet('Classifica Nostalgia')
    ...
    ws.freeze_panes(1, 4)
    workbook.close()
    print(f"Excel Nostalgia aggiornato: {EXCEL_OUT}", flush=True)
